  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-40 md:hidden bg-[#E07A5F] text-white w-14 h-14 rounded-full shadow-xl flex items-center justify-center"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <p className="text-[#1A1A1A] font-semibold text-sm">
              ¿Tenés un local en mente?
            </p>
            <p className="text-[#6B7280] text-xs mt-0.5">
              Consultá gratis y te pasamos un presupuesto sin compromiso.
            </p>
          </div>
          <button
            onClick={onOpenContact}
